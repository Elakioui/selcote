import AggregateOperations.Aggregation;
import AggregateOperations.Student;
...
public class AggregationTest {
    ...
    public void basicTestGetStudentNamesByDepartment() throws Exception {
        ...
        Map<String, List<String>> actual = Aggregation.getStudentNamesByDepartment(Arrays.stream(students));
